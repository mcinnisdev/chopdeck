...
export function Wordmark({ size = 'md', onDark = false, style }) {
  ...
  return (
    <span aria-label="Chop Deck" style={{ display: 'inline-flex', alignItems: 'baseline', gap: '.18em', fontFamily: 'var(--font-label)', fontWeight: 700, fontSize: fs, lineHeight: 1, letterSpacing: '-.01em', textTransform: 'uppercase', color: onDark ? 'var(--cream)' : 'var(--ink)', ...style }}>

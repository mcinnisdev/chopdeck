...
export default defineConfig({
  ...
  build: { rollupOptions: { input: { main: fileURLToPath(new URL('./index.html', import.meta.url)), manual: fileURLToPath(new URL('./manual/index.html', import.meta.url)), account: fileURLToPath(new URL('./account/index.html', import.meta.url)), terms: fileURLToPath(new URL('./terms/index.html', import.meta.url)), privacy: fileURLToPath(new URL('./privacy/index.html', import.meta.url)), kits: fileURLToPath(new URL('./kits/index.html', import.meta.url)), kitsPublish: fileURLToPath(new URL('./kits/publish/index.html', import.meta.url)), samples: fileURLToPath(new URL('./samples/index.html', import.meta.url)), samplesPublish: fileURLToPath(new URL('./samples/publish/index.html', import.meta.url)), beats: fileURLToPath(new URL('./beats/index.html', import.meta.url)), beat: fileURLToPath(new URL('./beat/index.html', import.meta.url)), publish: fileURLToPath(new URL('./publish/index.html', import.meta.url)), support: fileURLToPath(new URL('./support/index.html', import.meta.url)) } } },

...
const LICENSE_NAMES: Record<string, string> = { PD: 'Public domain', CC0: 'CC0, public domain', 'CC-BY': 'CC BY, credit the maker', 'CC-BY-NC': 'CC BY-NC, credit, no commercial use', CHOPDECK: 'Chop Deck licence, use here' };

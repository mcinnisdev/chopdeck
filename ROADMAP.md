...
- **Phase 8: Libraries.** `/samples/` and `/kits/` pages for curated and user-published sounds and pad
  banks, with licenses, quotas, reports and takedowns; "Send to machine" through the import tray.
